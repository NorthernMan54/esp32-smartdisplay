 ...
 //   display->sw_rotate = 1;
    ...
    esp_lcd_panel_io_3wire_spi_config_t io_3wire_spi_config = {
        .line_config = {
            ...
            .cs_gpio_num = AXS15231B_IO_3WIRE_SPI_LINE_CONFIG_CS_GPIO_NUM,
            .scl_io_type = IO_TYPE_GPIO,
            .scl_gpio_num = AXS15231B_IO_3WIRE_SPI_LINE_CONFIG_SCL_GPIO_NUM,
            .sda_io_type = IO_TYPE_GPIO,
            .sda_gpio_num = AXS15231B_IO_3WIRE_SPI_LINE_CONFIG_SDA_GPIO_NUM},
        .expect_clk_speed = AXS15231B_IO_3WIRE_SPI_EXPECT_CLK_SPEED,
        .spi_mode = AXS15231B_IO_3WIRE_SPI_SPI_MODE,
        .lcd_cmd_bytes = AXS15231B_IO_3WIRE_SPI_LCD_CMD_BYTES,
        .lcd_param_bytes = AXS15231B_IO_3WIRE_SPI_LCD_PARAM_BYTES,
        .flags = {.use_dc_bit = AXS15231B_IO_3WIRE_SPI_FLAGS_USE_DC_BIT, .dc_zero_on_data = AXS15231B_IO_3WIRE_SPI_FLAGS_DC_ZERO_ON_DATA, .lsb_first = AXS15231B_IO_3WIRE_SPI_FLAGS_LSB_FIRST, .cs_high_active = AXS15231B_IO_3WIRE_SPI_FLAGS_CS_HIGH_ACTIVE, .del_keep_cs_inactive = AXS15231B_IO_3WIRE_SPI_FLAGS_DEL_KEEP_CS_INACTIVE}};
    ...
    const esp_lcd_rgb_panel_config_t rgb_panel_config = {
        .clk_src = AXS15231B_PANEL_CONFIG_CLK_SRC,
        .timings = {
            .pclk_hz = AXS15231B_PANEL_CONFIG_TIMINGS_PCLK_HZ,
            .h_res = AXS15231B_PANEL_CONFIG_TIMINGS_H_RES,
            .v_res = AXS15231B_PANEL_CONFIG_TIMINGS_V_RES,
            .hsync_pulse_width = AXS15231B_PANEL_CONFIG_TIMINGS_HSYNC_PULSE_WIDTH,
            .hsync_back_porch = AXS15231B_PANEL_CONFIG_TIMINGS_HSYNC_BACK_PORCH,
            .hsync_front_porch = AXS15231B_PANEL_CONFIG_TIMINGS_HSYNC_FRONT_PORCH,
            .vsync_pulse_width = AXS15231B_PANEL_CONFIG_TIMINGS_VSYNC_PULSE_WIDTH,
            .vsync_back_porch = AXS15231B_PANEL_CONFIG_TIMINGS_VSYNC_BACK_PORCH,
            .vsync_front_porch = AXS15231B_PANEL_CONFIG_TIMINGS_VSYNC_FRONT_PORCH,
            .flags = {
                .hsync_idle_low = AXS15231B_PANEL_CONFIG_TIMINGS_FLAGS_HSYNC_IDLE_LOW,
                .vsync_idle_low = AXS15231B_PANEL_CONFIG_TIMINGS_FLAGS_VSYNC_IDLE_LOW,
                .de_idle_high = AXS15231B_PANEL_CONFIG_TIMINGS_FLAGS_DE_IDLE_HIGH,
                .pclk_active_neg = AXS15231B_PANEL_CONFIG_TIMINGS_FLAGS_PCLK_ACTIVE_NEG,
                .pclk_idle_high = AXS15231B_PANEL_CONFIG_TIMINGS_FLAGS_PCLK_IDLE_HIGH}},
        .data_width = AXS15231B_PANEL_CONFIG_DATA_WIDTH,
        .sram_trans_align = AXS15231B_PANEL_CONFIG_SRAM_TRANS_ALIGN,
        .psram_trans_align = AXS15231B_PANEL_CONFIG_PSRAM_TRANS_ALIGN,
        .hsync_gpio_num = AXS15231B_PANEL_CONFIG_HSYNC_GPIO_NUM,
        .vsync_gpio_num = AXS15231B_PANEL_CONFIG_VSYNC_GPIO_NUM,
        .de_gpio_num = AXS15231B_PANEL_CONFIG_DE_GPIO_NUM,
        .pclk_gpio_num = AXS15231B_PANEL_CONFIG_PCLK_GPIO_NUM,
        .data_gpio_nums = {AXS15231B_PANEL_CONFIG_DATA_GPIO_R0, AXS15231B_PANEL_CONFIG_DATA_GPIO_R1, AXS15231B_PANEL_CONFIG_DATA_GPIO_R2, AXS15231B_PANEL_CONFIG_DATA_GPIO_R3, AXS15231B_PANEL_CONFIG_DATA_GPIO_R4, AXS15231B_PANEL_CONFIG_DATA_GPIO_G0, AXS15231B_PANEL_CONFIG_DATA_GPIO_G1, AXS15231B_PANEL_CONFIG_DATA_GPIO_G2, AXS15231B_PANEL_CONFIG_DATA_GPIO_G3, AXS15231B_PANEL_CONFIG_DATA_GPIO_G4, AXS15231B_PANEL_CONFIG_DATA_GPIO_G5, AXS15231B_PANEL_CONFIG_DATA_GPIO_B0, AXS15231B_PANEL_CONFIG_DATA_GPIO_B1, AXS15231B_PANEL_CONFIG_DATA_GPIO_B2, AXS15231B_PANEL_CONFIG_DATA_GPIO_B3, AXS15231B_PANEL_CONFIG_DATA_GPIO_B4},
        .disp_gpio_num = AXS15231B_PANEL_CONFIG_DISP_GPIO_NUM,
        .on_frame_trans_done = direct_io_frame_trans_done,
        .user_ctx = display,
        .flags = {.disp_active_low = AXS15231B_PANEL_CONFIG_FLAGS_DISP_ACTIVE_LOW, .relax_on_idle = AXS15231B_PANEL_CONFIG_FLAGS_RELAX_ON_IDLE, .fb_in_psram = AXS15231B_PANEL_CONFIG_FLAGS_FB_IN_PSRAM}};
    ...
    log_d("refresh rate: %d Hz", (AXS15231B_PANEL_CONFIG_TIMINGS_PCLK_HZ * AXS15231B_PANEL_CONFIG_DATA_WIDTH) / (AXS15231B_PANEL_CONFIG_TIMINGS_H_RES + AXS15231B_PANEL_CONFIG_TIMINGS_HSYNC_PULSE_WIDTH + AXS15231B_PANEL_CONFIG_TIMINGS_HSYNC_BACK_PORCH + AXS15231B_PANEL_CONFIG_TIMINGS_HSYNC_FRONT_PORCH) / (AXS15231B_PANEL_CONFIG_TIMINGS_V_RES + AXS15231B_PANEL_CONFIG_TIMINGS_VSYNC_PULSE_WIDTH + AXS15231B_PANEL_CONFIG_TIMINGS_VSYNC_BACK_PORCH + AXS15231B_PANEL_CONFIG_TIMINGS_VSYNC_FRONT_PORCH) / SOC_LCD_RGB_DATA_WIDTH);
    const esp_lcd_panel_dev_config_t panel_dev_config = {
        .reset_gpio_num = AXS15231B_DEV_CONFIG_RESET_GPIO_NUM,
    ...
    ESP_ERROR_CHECK(esp_lcd_new_panel_axs15231b(io_handle, &rgb_panel_config, &panel_dev_config, &panel_handle));
