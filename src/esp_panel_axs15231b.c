...
#define AXS15231B_CMD_CND2BKxSEL 0xFF
...
esp_err_t axs15231b_init(esp_lcd_panel_t *panel)
{
    ...
    if ((res = esp_lcd_panel_io_tx_param(ph->io, AXS15231B_CMD_CND2BKxSEL, bkxsel, sizeof(bkxsel))) != ESP_OK)
    {
        log_e("Sending AXS15231B_CMD_CND2BKxSEL failed");
        return res;
    }
...
esp_err_t esp_lcd_new_panel_axs15231b(const esp_lcd_panel_io_handle_t io, const esp_lcd_rgb_panel_config_t *rgb_panel_config, const esp_lcd_panel_dev_config_t *panel_dev_config, esp_lcd_panel_handle_t *panel_handle)
{
